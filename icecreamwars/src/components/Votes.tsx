 ...
 return(
    <div className="Votes">
        ...
        <div className= "button-bar">
            ...
            <progress className="progress-Chocolate" value={chocolateVotes / getTotal()}></progress>
            <p>
            <label>Strawberry</label> {strawberryVotes} ({displayPercentage(strawberryVotes, getTotal())})
            </p>
            <progress className="progress-Strawberry" value={strawberryVotes / getTotal()}></progress>
            <p>
